...
shinyUI(bootstrapPage(
  ...
  sidebarPanel(
    ...
    tags$h4("MASTER:For feedback (problems, feature request and thank-you message) please use ",tags$br(), tags$a(href="https://github.com/jcolomb/Viewer-file-concatenator/issues","the github issue tracker."))
